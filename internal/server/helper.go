...
// Parameters:
// - data: A pointer to an any type (interface{}).
...
// The status code can be optionally overridden by passing a non-zero value for status. If
// status is not provided, a 400 Bad Request status is used.
